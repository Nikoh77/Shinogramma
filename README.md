...
Configure your bot using a configuration file, which allows for both essential and optional parameters. Optional parameters are particularly useful for restricting (banning) specific Telegram user IDs from accessing certain functions.
...
| `do_configure`    | Bans user IDs from accessing configuration settings. |
